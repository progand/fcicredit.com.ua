...
function art_add_admin() {
    ...
    add_theme_page("Modern Interiors WP Options", "Modern Interiors WP Options", 'edit_themes', basename(__FILE__), 'art_admin');
...
?>
<div class="wrap">
	<h2>Modern Interiors WP Options</h2>
