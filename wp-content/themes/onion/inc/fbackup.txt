		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/onion/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://websi.es' target='_blank'>Websi</a>, thanks to: <a href='http://wpdis.co/' target='_blank'>Best free WordPress themes</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/dreamy-responsive-children-wordpress-theme/' target='_blank'>WordPress child themes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
