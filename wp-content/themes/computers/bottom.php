		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/computers/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://www.howtosignupforwebhosting.com/hostgator-coupon-new-promo-codes/' target='_blank'>HostGator Coupons</a>, thanks to: <a href='http://www.boxintense.com/managed-dedicated-server/' target='_blank'>Managed Dedicated Server</a>, <a href='http://lizardthemes.com' target='_blank'>LizardThemes.com</a> and <a href='http://fthe.me/rockefeller-flexible-multipurpose-wp-theme/' target='_blank'>Free WP themes</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
