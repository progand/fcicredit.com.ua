		...
		switch ($param['type']) {
						...
						case 'text':
							...
							<div class='item'>
								...
								<?php } ?>
								<span class='span'><?php echo $param['ttl']?></span></p>
								<input autocomplete='off' class='tinput' type='text' name='<?php echo $param['name']?>' value='<?php echo $param['value']?>' />
							</div>
							<?php
						break;
						case 'textarea':
	...
	function customtext() {
		...
		?>
			<div class='item'>
								...
								<?php } ?>
								<span class='span'><?php echo $param['ttl']?></span></p>
								<input class='tinput' type='text' name='<?php echo $param['name']?>' value='<?php echo $param['value']?>' />
							</div>
		<?php
	}
