...
class QuestionnaireController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('createOnFrontend'),
                'users' => array('*'),
            ),
    ...
    public function actionCreateOnFrontend() {
        ...
        $model->source_url = "fcicredit.com.ua";
                ...
                try {
                    ...
                    $result = $client->SendWebRequestData(array(
                        "webRequestData" => array(
                            ...
                            "RequestedAmmount" => $model->requested_ammount,
                            "CurrencyCode" => $model->currency_code,
                            "TermString" => $model->term_string,
                            "ContactPhone" => $model->contact_phone,
                            "Email" => $model->email,
                            "ContactTimeString" => $model->contact_time_string,
                            "VisitorIP" => $model->visitor_ip,
        ...
        $this->render('create_on_frontend', array(
            'model' => $model,
            'exception' => $exception,
            'success' => $success,
            'wsdl' => $wsdl
